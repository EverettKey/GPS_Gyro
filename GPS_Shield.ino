...
#define LOG_FILE_PREFIX F("gpslog") // Name of the log file.
#define MAX_LOG_FILES 100 // Number of log files that can be made
#define LOG_FILE_SUFFIX F("csv") // Suffix of the log file
#define comma F(",")
char logFileName[13]; // Char string to store the log file name
// Data to be logged:
#define LOG_COLUMN_COUNT 15
char * log_col_names[LOG_COLUMN_COUNT] = {
  F("longitude"), F("latitude"), F("altitude"), F("speed"), F("course"), F("date"), F("time"), F("satellites"),
  F("AcX"), F("AcY"), F("AcZ"), F("Tmp"), F("GyX"), F("GyY"), F("GyZ")
